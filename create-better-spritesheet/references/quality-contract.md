...
Review canonical references for identity, anatomy, palette, equipment, direction, camera, visual mass, transparency, and native-size outline aesthetics. Complete the canonical Alpha admission and six-view visual preflight defined by [lineage-evidence.md](lineage-evidence.md). Treat a visible white fringe, jagged step, directional thickness spike, square corner, or outline bulge as a hard blocker, never an approval caveat.
...
Review the rendered sequence for topology, spacing, timing, transitions, events, native-size recognition, temporal outline flicker, transparent edges, clipping, loop seams, and terminal holds. Treat temporal outline flicker as a hard blocker. Use the [approval protocol](approval-protocol.md) for every gate and [lineage-evidence.md](lineage-evidence.md) for package proof semantics.
...
| Canonical low-Alpha boundary, white fringe, removal residue, or preview edge is wrong                                                                    | Canonical authoring and Alpha cleanup                | Correct the source or Alpha policy; regenerate admission and preview evidence; do not open canonical approval                                        |
...
| Ring pixels, jagged steps, directional thickness spikes, square corners, bulges, outline thickness or color, safe margin, sampling, or assembly is wrong | Outline contract or deterministic renderer           | Correct the contract or renderer; regenerate canonical admission when affected, receipt, manifest, sheet, checkpoints, reviews, and delivery binding |
| Temporal outline flicker is visible                                                                                                                      | Raw frame-source authoring or deterministic renderer | Correct the earliest inconsistent silhouette or rendering input; repeat affected sequence and package review before delivery                         |
